...
class SwitchConnection(object):
    ...
    def ReadDirectCounters(self, table_entries, dry_run=False):
        request = p4runtime_pb2.ReadRequest()
        request.device_id = self.device_id
    ...
    def ResetDirectCounters(self, table_entry, dry_run=False):
        request = p4runtime_pb2.WriteRequest()
        request.device_id = self.device_id
        request.election_id.low = 1
        modify = request.updates.add()
        modify.type = p4runtime_pb2.Update.MODIFY
        modify.entity.direct_counter_entry.table_entry.CopyFrom(table_entry)
        modify.entity.direct_counter_entry.data.byte_count = 0
        modify.entity.direct_counter_entry.data.packet_count = 0
